...
Set this as default model for the agent: "google/gemini-2.5-flash"

Do not set "anthropic/claude-3.5-sonnet" (claude 3.5 Sonnet) as default model. 
It is very expensive in OpenRouter. 
